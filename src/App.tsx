...
import { Upload, Video, CheckCircle, Loader2, Download, Languages, Play } from 'lucide-react';
...
export default function App() {
  ...
  const processVideo = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Erreur lors de la lecture de la transcription IA');
      }
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-[#141414] font-sans">
      {/* Header */}
      <header className="border-b border-black/5 p-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-[#FF4D00] rounded-full flex items-center justify-center">
            <Languages className="text-white w-6 h-6" />
          </div>
          <h1 className="text-xl font-bold tracking-tight">EcoSub <span className="font-light italic">AI</span></h1>
        </div>
        <div className="text-xs uppercase tracking-widest opacity-50 font-mono">
          Bilingual Subtitle Engine v1.0
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto p-8 pt-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-6">
            <h2 className="text-5xl font-medium leading-[1.1] tracking-tighter">
              Donnez une voix <br />
          ...
          <div className="md:col-span-7">
            <motion.div 
              layout
              className="bg-white border border-black/10 rounded-3xl p-8 shadow-2xl shadow-black/5 min-h-[400px] flex flex-col justify-center"
            >
                ...
                {status === 'idle' && (
                  ...
                  >
                    <div 
                      ...
                      className="border-2 border-dashed border-black/10 rounded-2xl p-12 cursor-pointer hover:border-[#FF4D00]/30 transition-colors group"
                    >
                      <input 
                        type="file" 
                        ref={fileInputRef} 
